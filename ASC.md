...
- Latest external build: `1.0 (61)` / `44aad8f0-c2c5-42b0-906b-a1101a7e7fd3`, approved on `2026-07-11` for external TestFlight from `master` `d201aba`; Internal and External states are both `IN_BETA_TESTING`.
