...
TARGET_SHELL_RC_FILE="${MOBIDEX_SMOKE_TARGET_SHELL_RC_FILE:-"$WORK_DIR/smoke-shell-rc"}"
...
if [[ -z "${MOBIDEX_SMOKE_TARGET_SHELL_RC_FILE:-}" ]]; then
  : >"$TARGET_SHELL_RC_FILE"
fi
...
launch_env=(
  ...
  "SIMCTL_CHILD_MOBIDEX_SMOKE_TARGET_SHELL_RC_FILE=$TARGET_SHELL_RC_FILE"
