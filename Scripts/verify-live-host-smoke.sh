...
for key in MOBIDEX_SMOKE_SERVER_ID MOBIDEX_SMOKE_NEW_SESSION_LOCATION MOBIDEX_SMOKE_PROMPT MOBIDEX_SMOKE_EXPECTED_TEXT MOBIDEX_SMOKE_STEER_TEXT MOBIDEX_SMOKE_PASSWORD MOBIDEX_SMOKE_PRIVATE_KEY_BASE64 MOBIDEX_SMOKE_PRIVATE_KEY_PASSPHRASE MOBIDEX_SMOKE_SEED_PROJECT_STATE MOBIDEX_SMOKE_BROWSE_PATH; do
  if [[ -n "${!key:-}" ]]; then
